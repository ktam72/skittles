...
| f | **ファイル検索**：カレントディレクトリ配下を再帰的に glob 検索、結果をビューア表示 |
| g | **Grep**：カレントディレクトリ配下のファイル内容を case-insensitive 検索 |
...
| 機能 | 操作 | 説明 |
|------|------|------|
| ファイル検索 | `f` | カレントディレクトリ配下を glob 再帰検索 |
| Grep | `g` | カレントディレクトリ配下のファイル内容検索 |
...
Phase16  ─ インクリメンタルサーチ                ⬜ 未着手
Phase17  ─ Homebrew Formula / 配布               ⬜ 未着手
Phase18  ─ プラグインシステム                    ⬜ 未着手
```
